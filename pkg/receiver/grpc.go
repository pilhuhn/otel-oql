...
func (r *GRPCReceiver) Start(ctx context.Context) error {
	...
	ptraceotlp.RegisterGRPCServer(r.server, &traceHandler{ingester: r.ingester, obs: r.obs, debugIngestion: r.debugIngestion})
	pmetricotlp.RegisterGRPCServer(r.server, &metricHandler{ingester: r.ingester, obs: r.obs, debugIngestion: r.debugIngestion})
	plogotlp.RegisterGRPCServer(r.server, &logHandler{ingester: r.ingester, obs: r.obs, debugIngestion: r.debugIngestion})
...
func (h *traceHandler) Export(ctx context.Context, req ptraceotlp.ExportRequest) (ptraceotlp.ExportResponse, error) {
	...
	// [DEBUG INGESTION] Print incoming trace data
	if h.debugIngestion {
...
func (h *metricHandler) Export(ctx context.Context, req pmetricotlp.ExportRequest) (pmetricotlp.ExportResponse, error) {
	...
	// [DEBUG INGESTION] Print incoming metric data
	if h.debugIngestion {
...
func (h *logHandler) Export(ctx context.Context, req plogotlp.ExportRequest) (plogotlp.ExportResponse, error) {
	...
	// [DEBUG INGESTION] Print incoming log data
	if h.debugIngestion {
